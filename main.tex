...
\autor{\brazilword{Vitor Matheus Valandro da Rosa}}
\titulo{\lang{Work Title\protect\\Could be break into two lines}{Anonimização de Dados Clínicos para Pesquisa em Saúde}}

% FIXME: Se houver subtítulo, descomente a linha abaixo
\subtitulo{\lang{Subtitle}{Uma Abordagem em Conformidade com a LGPD}}

% FIXME: Siglas para grau de formação Dr./Dra., Me./Ma, Bel. Bela. (inglês: PhD., MSc., Bs.)
\orientador[\lang{Supervisor}{Orientadora}]{\brazilword{Giovana Nunes Inocêncio}, \lang{Me.}{Me.}}

% FIXME: Se houver coorientador, descomente a linha abaixo
\coorientador[\lang{Co-supervisor}{Coorientador}]{\brazilword{ Jean Everson Martina}, \lang{Dr.}{Dr.}}
...
\data{\lang{8 de dezembro}{8 de dezembro} 2025}

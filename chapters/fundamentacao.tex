...
Para alcançar seus objetivos, toda a lógica de tratamento de dados sob a LGPD é orientada por dez princípios fundamentais, listados em seu Art. 6º. Dentre eles, destacam-se o \textbf{princípio da finalidade}, que exige que o tratamento seja realizado para propósitos legítimos, específicos e informados ao titular; o \textbf{princípio da necessidade}, que limita o tratamento ao mínimo necessário para atingir suas finalidades; e o \textbf{princípio da transparência}, que garante aos titulares informações claras e acessíveis sobre o tratamento \cite{Brasil2018lgpd}. Esses princípios, segundo \citeonline{Doneda2019}, formam o núcleo de questões que qualquer ordenamento jurídico deve enfrentar ao regular a proteção de dados, servindo como a espinha dorsal para a interpretação e aplicação de toda a lei.
